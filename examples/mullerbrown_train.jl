...
# plot
f0, ax0 = plot_contours_2d(ref, coord_grid; fill=true, lvls=ctr_lvls2)
...
pce.params = param_dict["ts2"]["EF"][9]
ctr_lvls2 = -100:25:200
f, _ = plot_contours_2d(pce, coord_grid, fill=true, lvls=ctr_lvls2)
